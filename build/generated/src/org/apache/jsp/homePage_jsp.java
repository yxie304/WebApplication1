...
public final class homePage_jsp extends org.apache.jasper.runtime.HttpJspBase
  ...
  public void _jspService(HttpServletRequest request, HttpServletResponse response)
    ...
    try {
      ...
      out.write("    epsg900913 = new OpenLayers.Projection(\"EPSG:3857\");\n");
      ...
      out.write("    \n");
      out.write("    \n");
      out.write("    var projWGS84 = new OpenLayers.Projection(\"EPSG:4326\");\n");
      out.write("    var proj900913 = new OpenLayers.Projection(\"EPSG:900913\");\n");
      out.write("\n");
      out.write("    var point = new OpenLayers.LonLat(-939488028, 399896208);\n");
      out.write("    var point2 =  point.transform(proj900913, projWGS84);\n");
      out.write("    \n");
      out.write("    \n");
      out.write("\n");
      out.write("    var list = [\n");
      ...
      out.write("        );    \n");
      out.write("    vectorLayer.addFeatures(feature); -939488028, 399896208 -84.3963, 33.7756\n");
      out.write("   \n");
      out.write("    }\n");
      out.write("    \n");
      out.write("            /**\n");
      out.write("    var lalala = new OpenLayers.LonLat(-939488028, 399896208).transform(proj900913, projWGS84);\n");
      out.write("            \n");
      out.write("    \n");
      out.write("    var feature = new OpenLayers.Feature.Vector(\n");
      out.write("            new OpenLayers.Geometry.Point(lalala).transform(epsg4326, projectTo),\n");
      out.write("            //new OpenLayers.LonLat(-939488028, 399896208).transform(proj900913, projWGS84),\n");
      out.write("            {description:'xieyi'} ,\n");
      out.write("            {externalGraphic: 'http://dev.openlayers.org/icons/image2.gif', graphicHeight: 25, graphicWidth: 21, graphicXOffset:-12, graphicYOffset:-25  }\n");
      out.write("        );    \n");
      out.write("    \n");
